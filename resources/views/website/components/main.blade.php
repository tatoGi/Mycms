<section class="section-cover">
      <span class="cover">
        <img src="assets/images/Mask Group 86.png" alt="">
      </span>
    ...
    <section class="service-slider container">
        <div class="row">
            <h2><a href="">ყველა სერვისი</a></h2>

            <span class="slickarrow-prev slickarrow icon-next"></span>

            <span class="slickarrow-next slickarrow icon-next"></span>
            <div class="serviceslider">
                <div><a href="">
                    <img src="assets/images/ruler.png" alt="">
                    <h4>შიდა აზომვა</h4>
                    <p>ისწავლეთ დროის ეფექტური მართვა და თავდაჯერებული რაღაცეები</p>
                    <span class="icon-long-yellow-arrow"></span>
                </a></div>
                <div><a href="">
                    <img src="assets/images/ruler.png" alt="">
                    <h4>შიდა აზომვა</h4>

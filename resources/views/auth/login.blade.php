		...
		<div class="container-login100">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" style="text-align: center" data-tilt>
					<img style="width:80%" src="/logo.jpg" alt="IMG">
				</div>
				...
				<form method="POST" class="login100-form validate-form" action="{{ route('login', app()->getLocale()) }}">
					...
					<div class="wrap-input100">
						<input class="input100" type="email" name="email" value="" placeholder="ელ-ფოსტა" id="email">
					...
					<div class="wrap-input100 validate-input" data-validate="Password is required">
						<input class="input100" type="password" name="password" placeholder="პაროლი">
